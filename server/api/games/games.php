...
try {
    // Remove any UTF-8 BOM or whitespace
    ...
    // Only set CORS headers if not on localhost
    ...
    try {
        ...
        switch ($method) {
            case 'GET':
                if ($action === 'check_gameId') {
                    ...
                    error_log("First 1000 chars of response: " . substr($json_response, 0, 1000));
                    
                    // Clear any existing output and send response
        ...
        // Ensure all output is sent and buffering is ended
